...
export const SmallBlux = ({
  ...
  >
    ...
    <path d="M41.0809 6.06641H6.16162V11.0858H41.0809V6.06641Z" fill={fill} />
    <path
      d="M11.0193 21.8516V6H6V21.8516V23.6323V28.6516V41.2032V46.2226V46.2387H11.0193V46.2226H41.0838V41.2032H11.0193V28.6516H41.0838V23.6323H11.0193V21.8516Z"
      fill={fill}
    />
    <path d="M46.0001 11.1621H41.1614V23.7428H46.0001V11.1621Z" fill={fill} />
    <path d="M46.0001 28.582H41.1614V41.1627H46.0001V28.582Z" fill={fill} />
  </svg>
);
