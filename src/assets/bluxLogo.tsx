...
export function BluxLogo({ fill = 'black' }: BluxLogoProps) {
  return html`
    <svg
      width="150"
      height="32"
    ...
    >
      <g clip-path="url(#clip0_84_13134)">
        <path
          d="M41.7486 0.558624H37.8855V25.7212H41.7486V0.558624Z"
          fill=${fill}
        />
        <path
          d="M66.5053 27.5581H37.9539V31.5305H66.5053V27.5581Z"
          fill=${fill}
        />
        <path
        ...
        />
        <path
          d="M99.5805 27.5907H76.3992V31.4538H99.5805V27.5907Z"
          fill=${fill}
        />
        <path
        ...
        />
        <path
          d="M31.7456 4.46902H28.0215V14.1517H31.7456V4.46902Z"
          fill=${fill}
        />
        <path
          d="M31.7456 17.8756H28.0215V27.5583H31.7456V17.8756Z"
          fill=${fill}
        />
        <path
